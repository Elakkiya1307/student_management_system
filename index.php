<?php
session_start();           // MUST be first - keep session alive

// Remove these lines:
// session_destroy();      // ← delete this
// error_reporting(0);     // better to see errors during development

$message = isset($_SESSION['message']) ? $_SESSION['message'] : null;

// Clear the message after displaying (good practice)
